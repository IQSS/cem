...
\begin{quote}
  ...
  and Stefano M.\ Iacus, Gary King, and Giuseppe Porro, ``Matching for
  Causal Inference Without Balance Checking: Coarsened Exact
  Matching'',
...
\citep{KinZen06,HoImaKin07,IacKinPor09a,IacKinPor09}.  If used for analyzing
...
measure \citep{IacKinPor09a}.  The measure is based on the $\mathcal
...
summary(LeLonde)
@
Now we use \code{Amelia} package \citep{HonKinBLa09} to create
...
\input{../man/cem.Rd}
\input{../man/att.Rd}
\input{../man/cemspace.Rd}
\input{../man/DW.Rd}
\input{../man/imbalance.Rd}
\input{../man/imbspace.Rd}
\input{../man/k2k.Rd}
\input{../man/L1.meas.Rd}
\input{../man/L1.profile.Rd}
\input{../man/LL.Rd}
\input{../man/LeLonde.Rd}
\input{../man/pair.Rd}
\input{../man/plot.spg.Rd}
\input{../man/relax.cem.Rd}
\input{../man/shift.cem.Rd}
\input{../man/spacegraph.Rd}
